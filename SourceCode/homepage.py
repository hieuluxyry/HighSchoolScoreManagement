...
class HomePage(Tk):
    def __init__(self, db_connection):
        ...
        label_title = Label(self, text="Chào mừng bạn đến với Quản lý điểm hệ THPT !", font=("Time New Roman", 16))
        ...
        button_add_student.config(bg="white",fg="blue")
        ...
        button_add_class.config(bg="white",fg="blue")
        ...
        button_add_subject.config(bg="white",fg="blue")
        ...
        button_add_score.config(bg="white",fg="blue")
